...
namespace Drupal\Tests\marvin_phpstan\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-phpstan-tests-project_01',
      'description' => 'drupal/marvin-phpstan-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_phpstan']['fixtures']['filesToSymlink'] ?? [];
